# -*- coding: utf-8 -*-
#
# et-demands documentation build configuration file, created by
...
htmlhelp_basename = 'et-demandsdoc'
...
man_pages = [
    (master_doc, 'et-demands', u'et-demands Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'et-demands', u'et-demands Documentation',
   author, 'et-demands', 'One line description of project.',
   'Miscellaneous'),
]
